namespace QRnBarcodeScanner.Views
{
    using QRnBarcodeScanner.Models;
    using QRnBarcodeScanner.Services.DataService;
    using QRnBarcodeScanner.Services.ScannerService;
    using QRnBarcodeScanner.Services.SettingsService;
    using QRnBarcodeScanner.Services.ShareService;
    using QRnBarcodeScanner.ViewModels;
